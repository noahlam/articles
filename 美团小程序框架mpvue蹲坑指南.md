...
感觉小程序还是有在努力的,支持大部分es6语法了,还出了一个类Vue的框架wepy,还支持redux状态管理,
就大致建了个demo,跑了起来,感觉虽然没有vue那么酸爽,但是还是挺ok的,至少比原生的小程序语法亲民很多.
...
后面就准备放弃，想其他解决方案了，没想到今天在官方文档 -`scroll-view组件`的介绍的最底部的 **小字** 里看到了

> tip: 请勿在 scroll-view 中使用 textarea、map、canvas、video 组件

进一步查看了`canvas组件`的文档，发现也有类似的提示
